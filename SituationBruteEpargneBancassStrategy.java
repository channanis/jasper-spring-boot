...
/**
 * Génère l'attestation "Situation brute de l'épargne" (bancassurance / rachat).
 ...
 *
 * Adapter le package (ma.lamarocainevie.msapiprinting.*) et les imports
 * (DocumentFormat / GeneratedDocument / JasperRenderingService) au projet réel si nécessaire.
 */
@Component
@Slf4j
public class SituationBruteEpargneBancassStrategy implements DocumentGeneratorStrategy {

    public static final String CODE = "SITUATION_BRUTE_EPARGNE_BANCASS";
    private static final String TEMPLATE = "templates/situation_brute_epargne_bancass.jrxml";
    private static final DateTimeFormatter FR_DATE = DateTimeFormatter.ofPattern("dd/MM/yyyy");

    private final JasperRenderingService renderingService;

    public SituationBruteEpargneBancassStrategy(JasperRenderingService renderingService) {
    ...
    public GeneratedDocument generate(Map<String, Object> data, DocumentFormat format) {
        ...
        String fileName = "situation_brute_epargne_%s.%s".formatted(numeroAdhesion, format.extension());
    ...
    private Map<String, Object> buildReportParameters(Map<String, Object> data) {
        ...
        p.put("prenom", optionalString(data, "prenom", ""));
        ...
        // svk peut être absent/nul -> repli sur mtcot géré côté template
        p.put("svk", optionalDecimal(data, "svk"));
        p.put("mtcot", requireDecimal(data, "mtcot"));
        p.put("mtavance", requireDecimal(data, "mtavance"));
        p.put("vprim", requireDecimal(data, "vprim"));
        return p;
    }
    ...
    private BigDecimal optionalDecimal(Map<String, Object> data, String key) {
        Object value = data.get(key);
