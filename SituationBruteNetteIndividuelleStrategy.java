...
/**
 * Génère l'attestation "Situation brute et nette" pour les contrats Individuels.
...
@Component
@Slf4j
public class SituationBruteNetteIndividuelleStrategy implements DocumentGeneratorStrategy {

    public static final String CODE = "SITUATION_BRUTE_NETTE_INDIVIDUELLE";
    private static final String TEMPLATE = "templates/situation_brute_nette_individuelle.jrxml";
    private static final DateTimeFormatter FR_DATE = DateTimeFormatter.ofPattern("dd/MM/yyyy");

    private final JasperRenderingService renderingService;

    public SituationBruteNetteIndividuelleStrategy(JasperRenderingService renderingService) {
    ...
    public GeneratedDocument generate(Map<String, Object> data, DocumentFormat format) {
        ...
        String numeroBase = requireString(data, "numeroBase");
        String fileName = "situation_brute_nette_%s.%s".formatted(numeroBase, format.extension());
    ...
    private Map<String, Object> buildReportParameters(Map<String, Object> data) {
        ...
        p.put("numeroBase", requireString(data, "numeroBase"));
