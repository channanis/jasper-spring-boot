...
public class SituationNetteGroupeDocumentDTO {
    private String nom;
    ...
    private Double montantAvanceNonRembourseeCapitalisee;
    ...
    public Map<String, Object> toMap() {
        ...
        map.put("montantAvanceNonRembourseeCapitalisee", montantAvanceNonRembourseeCapitalisee);
    ...
    public Double getMontantAvanceNonRembourseeCapitalisee() { return montantAvanceNonRembourseeCapitalisee; }
    public void setMontantAvanceNonRembourseeCapitalisee(Double montantAvanceNonRembourseeCapitalisee) { this.montantAvanceNonRembourseeCapitalisee = montantAvanceNonRembourseeCapitalisee; }
